        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <tbody>
                <tr class="companyinfo" v-for="company in companies" :key="company._id">
                    ...
                    <td v-else><router-link :to="{name: 'CompanyBioLeasedView', params: {id: company.c_id}}" class="btn btn-primary btn-sm action-btn">Company Bio</router-link></td>
                    ...
                    <td>
                        <span>
                            <router-link :to="{name: 'EditCompanyComp', params: {id: company.c_id}}" class="btn btn-warning btn-sm action-btn">Edit</router-link>
...
import axios from "axios";
  ...
  export default {
    ...
    created() {
          ...
          let apiURL2 = 'http://localhost:8080/api/companies_bios'
